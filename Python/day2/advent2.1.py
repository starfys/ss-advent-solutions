#!/usr/bin/python3
"""
Solves the first problem in the second pair of advent of code problems
...
"""
import sys
print(sum(list(map(lambda coords: 3*coords[0]*coords[1] + 2*coords[2]*(coords[0]+coords[1]), map(lambda line: sorted(list(map(int, line.rstrip().split("x")))), sys.stdin.readlines())))))
